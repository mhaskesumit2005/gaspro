            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                ...
                <ul class="menu-inner py-1">
                    ...
                    <li class="menu-item">
                        ...
                        <ul class="menu-sub">
                            <li class="menu-item">
                                <a href="<?=base_url()?>master/add_driver" class="menu-link">
                                    <div data-i18n="Add Drivers">Add Driver</div>
                                </a>
                            </li>
                            <li class="menu-item">
                                <a href="<?=base_url()?>master/driver_list" class="menu-link">
                                    <div data-i18n="Driver List">Driver List</div>
                                </a>
                            </li>
                        </ul>
                    </li>
