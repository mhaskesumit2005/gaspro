<div class="row">
    <div class="col-md-12">
        <ul class="nav nav-pills flex-column flex-md-row mb-3">
            <li class="nav-item">
                <a class="nav-link" href="<?= base_url() ?>transport/profile"><i class="bx bx-user me-2"></i> Profile</a>
            </li>
            <li class="nav-item">
                <a class="nav-link active" href="<?= base_url() ?>transport/setting"><i class='bx bxs-lock bx-tada me-2'></i> Security</a>
            </li>
            <li class="nav-item">
        ...
        <div class="card mb-4">
            ...
            <hr class="my-0" />
            <div class="card-body">
                <form id="changePasswordForm" action="<?= base_url() ?>transport/update_password" method="post" novalidate>
